...
libbi sample --target joint --model-file Lorenz96.bi --end-time 10 --noutputs 100 --nsamples 1 --output-file data/obs_dense.nc --init-file data/init.nc --init-np 38271 --seed 1
