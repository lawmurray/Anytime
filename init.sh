...
libbi sample --target joint --model-file Lorenz96.bi --end-time 10 --noutputs 100 --nsamples 1 --output-file data/obs_dense.nc --init-file data/init_zoom.nc --init-np 921 --seed 1
